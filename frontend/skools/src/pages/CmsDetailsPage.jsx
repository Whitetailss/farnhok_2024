...
const PureCmsDetailsPage = ({
  ...
  return (
    <div>
      <div className='cmsButtonNav'>
        <Button color='warning' className='cmsBtn' onClick={submitInfo}>Save this section</Button>
      </div>
      <Uploader style={bannerUploader.style} text={bannerUploader.text} hasCaption='hide' hasClear='hide' uploaderName='banner' />
      ...
      <Row style={{ padding: '3vw' }}>
        ...
        <Col xs="6">
          <div id='video-box' style={{ position: 'relative' }}>
            <div id='video_overlays'>
              <Uploader style={smallUploader.style} text={smallUploader.text1} uploaderName='mainVideo' hasCaption='hide' hasClear='hide' />
            </div>
            <video style={{ position: 'absolute', left: '0', width: '45vw', minHeight: '300px', maxHeight: '300px' }} controls src={videoUrl} type='video/mp4'></video>
          </div>
        </Col>
      </Row>
