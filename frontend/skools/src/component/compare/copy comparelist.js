...
import { useNavigate } from 'react-router-dom';import { connect } from 'react-redux';
...
const PureCompareList = ({ compare, history }) => {
  useEffect(() => {
    if (compare.length === 0) {
      history.push('/search');
    }
    window.scrollTo(0, 0);
  }, [compare.length, history]);
                ...
                <Container>
                            ...
                            return (
                                <Col key={Math.random()} md='5' sm='6' xs='6' className={`compareListBox${index}`}>
                                    <div>
                                        {index === 0? (
                                            <div>
                                                {(school.school_size > compare[1].school_size) ? (
                                            ...
                                            <div>
                                                {(school.school_size > compare[0].school_size) ? (
                                                    <p >{school.school_size} m<sup>2</sup><span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                    ) : <p>{school.school_size} m<sup>2</sup></p>}
                                            </div>
                                        )}
                    ...
                    <Row>
                        ...
                        {compare.map((school, index) => {
                            ...
                            var totalStudent0 = compare[0].am_student + compare[0].pm_student + compare[0].full_day_student + compare[0].long_full_day_student;
                            var totalStudent1 = compare[1].am_student + compare[1].pm_student + compare[1].full_day_student + compare[1].long_full_day_student;
                            return (
                                <Col key={Math.random()} md='5' sm='6' xs='6' className={`compareListBox${index}`}>
                                    <div>
                                        {index === 0? (
                                    ...
                                    <div>
                                        {school.has_am? (
                                            <div className='compareListClass'>
                                                {index === 0? (
                                                    <div>
                                                        {((school.am_student > compare[1].am_student) || (!compare[1].has_am)) ? (
                                                        ...
                                                        {((school.half_day_tuition < compare[1].half_day_tuition) || (!compare[1].has_am)) ? (
                                                    ...
                                                    <div>
                                                        {((school.am_student > compare[0].am_student) || (!compare[0].has_am)) ? (
                                                            <p>{school.am_student} students<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>{school.am_student} students</p>}
                                                        {((school.half_day_tuition < compare[0].half_day_tuition) || (!compare[0].has_am)) ? (
                                                            <p>${school.half_day_tuition}  per year<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>${school.half_day_tuition}  per year</p>}
                                                    </div>
                                                )}    
                                    ...
                                    <div>
                                        {school.has_pm? (
                                            <div className='compareListClass'>
                                                {index === 0? (
                                                    <div>
                                                        {((school.pm_student > compare[1].pm_student) || (!compare[1].has_pm)) ? (
                                                        ...
                                                        {((school.half_day_tuition < compare[1].half_day_tuition) || (!compare[1].has_pm)) ? (
                                                            <p>${school.half_day_tuition}  per year<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>${school.half_day_tuition}  per year</p>}
                                                    </div>
                                                ) : (
                                                    <div>
                                                        {((school.pm_student > compare[0].pm_student) || (!compare[0].has_pm)) ? (
                                                            <p>{school.pm_student} students<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>{school.pm_student} students</p>}
                                                        {((school.half_day_tuition < compare[0].half_day_tuition) || (!compare[0].has_pm)) ? (
                                                            <p>${school.half_day_tuition}  per year<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>${school.half_day_tuition}  per year</p>}
                                                    </div>
                                                )}    
                                    ...
                                    <div>
                                        {school.has_full_day? (
                                            <div className='compareListClass'>
                                                {index === 0? (
                                                    <div>
                                                        {((school.full_day_student > compare[1].full_day_student) || (!compare[1].has_full_day)) ? (
                                                        ...
                                                        {((school.full_day_tuition < compare[1].full_day_tuition) || (!compare[1].has_full_day)) ? (
                                                    ...
                                                    <div>
                                                        {((school.full_day_student > compare[0].full_day_student) || (!compare[0].has_full_day)) ? (
                                                            <p>{school.full_day_student} students<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>{school.full_day_student} students</p>}
                                                        {((school.full_day_tuition < compare[0].full_day_tuition) || (!compare[0].has_full_day)) ? (
                                                            <p>${school.full_day_tuition}  per year<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>${school.full_day_tuition}  per year</p>}
                                                    </div>
                                                )}    
                                    ...
                                    <div>
                                        {school.has_long_full_day? (
                                            <div className='compareListClass'>
                                                {index === 0? (
                                                    <div>
                                                        {((school.long_full_day_student > compare[1].long_full_day_student) || (!compare[1].has_long_full_day)) ? (
                                                        ...
                                                        {((school.long_full_day_tuition < compare[1].long_full_day_tuition) || (!compare[1].has_long_full_day)) ? (
                                                    ...
                                                    <div>
                                                        {((school.long_full_day_student > compare[0].long_full_day_student) || (!compare[0].has_long_full_day)) ? (
                                                            <p>{school.long_full_day_student} students<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>{school.long_full_day_student} students</p>}
                                                        {((school.long_full_day_tuition < compare[0].long_full_day_tuition) || (!compare[0].has_long_full_day)) ? (
                                                            <p>${school.long_full_day_tuition}  per year<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>${school.long_full_day_tuition}  per year</p>}
                                                    </div>
                                                )}    
                                    ...
                                    <div>
                                        {school.has_subsidy? (
                                            <div>
                                                {index === 0? (
                                                    <div>
                                                        {((school.subsidy_amt < compare[1].subsidy_amt) || (!compare[1].has_subsidy)) ? (
                                                    ...
                                                    <div>
                                                        {((school.subsidy_amt < compare[0].subsidy_amt) || (!compare[0].has_subsidy)) ? (
                                                            <p>${school.subsidy_amt}  per year<span> <FontAwesomeIcon size="1x" icon={faThumbsUp} color='#0FACF3'/></span></p>
                                                        ) : <p>${school.subsidy_amt}  per year</p>}
                                                    </div>
                                                )}    
...
export const CompareList = connect(mapStateToProps, mapDispatchToProps)(
    PureCompareList
  );